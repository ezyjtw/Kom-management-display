...
async function main() {
  ...
  if (existingThreadCount === 0) {
    const threadData = [
      {
        source: CommsSource.email, sourceThreadRef: "gmail-thread-001",
        ...
        priority: ThreadPriority.P1, status: ThreadStatus.InProgress, ownerUserId: emp["alice@ops.com"].id,
        queue: "Transaction Operations", lastMessageAt: new Date("2026-02-28T09:30:00Z"), lastActionAt: new Date("2026-02-28T09:45:00Z"),
      },
      {
        source: CommsSource.slack, sourceThreadRef: "C01234-1709100000.000001",
        ...
        priority: ThreadPriority.P2, status: ThreadStatus.WaitingExternal, ownerUserId: emp["eva@ops.com"].id,
        queue: "Admin Operations", lastMessageAt: new Date("2026-02-27T16:00:00Z"), lastActionAt: new Date("2026-02-27T16:30:00Z"),
      },
      {
        source: CommsSource.email, sourceThreadRef: "gmail-thread-003",
        ...
        priority: ThreadPriority.P2, status: ThreadStatus.Unassigned, queue: "Transaction Operations",
        lastMessageAt: new Date("2026-02-28T08:00:00Z"), ttoDeadline: new Date("2026-02-28T10:00:00Z"),
      },
      {
        source: CommsSource.slack, sourceThreadRef: "C05678-1709200000.000002",
        ...
        priority: ThreadPriority.P0, status: ThreadStatus.Assigned, ownerUserId: emp["david@ops.com"].id,
        queue: "Transaction Operations", lastMessageAt: new Date("2026-02-28T10:15:00Z"), ttfaDeadline: new Date("2026-02-28T10:25:00Z"),
      },
      {
        source: CommsSource.email, sourceThreadRef: "gmail-thread-005",
        ...
        priority: ThreadPriority.P1, status: ThreadStatus.Assigned, ownerUserId: emp["carol@ops.com"].id,
        queue: "Transaction Operations", lastMessageAt: new Date("2026-02-28T07:00:00Z"), lastActionAt: new Date("2026-02-28T08:30:00Z"),
      },
      {
        source: CommsSource.email, sourceThreadRef: "gmail-thread-006",
        ...
        priority: ThreadPriority.P3, status: ThreadStatus.Done, ownerUserId: emp["bob@ops.com"].id,
  ...
  if (existingChecks === 0) {
    ...
    const checkCategories = [
      { name: "Stuck Transactions", category: "stuck_tx", autoCheckKey: "stuck_tx_count", status: DailyCheckStatus.issues_found, notes: "3 stuck BTC transactions >2h" },
      { name: "Balance Variance", category: "balance_variance", autoCheckKey: "balance_variance", status: DailyCheckStatus.pass },
      { name: "Staking Rewards", category: "staking_rewards", autoCheckKey: "staking_overdue", status: DailyCheckStatus.pass },
      { name: "Screening Queue", category: "screening", autoCheckKey: "screening_pending", status: DailyCheckStatus.pass },
      { name: "Travel Rule Cases", category: "travel_rule", autoCheckKey: "travel_rule_open", status: DailyCheckStatus.pass },
      { name: "Pending Approvals", category: "pending_approvals", autoCheckKey: "pending_approvals", status: DailyCheckStatus.pass },
      { name: "Scam / Dust Review", category: "scam_dust", autoCheckKey: "scam_dust_pending", status: DailyCheckStatus.pass },
      { name: "Validator Health", category: "validator_health", autoCheckKey: "", status: DailyCheckStatus.pass },
      { name: "External Provider Status", category: "external_provider", autoCheckKey: "active_incidents", status: DailyCheckStatus.pass },
    ];
    ...
    const todayChecks = checkCategories.map((c, idx) => ({
      ...
      category: c.category,
      autoCheckKey: c.autoCheckKey,
      status: idx < 4 ? DailyCheckStatus.pass : DailyCheckStatus.pending,
      notes: "",
