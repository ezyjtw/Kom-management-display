...
- **Production on Railway** (permitted since 2026-09-25, H10 removed): secrets are Railway variables, marked sealed in the dashboard, because Railway cannot mount files (`src/lib/secrets.ts`). `DATABASE_URL` carries a password there.
