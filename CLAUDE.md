...
| H10 | ~~Remove Railway config~~ **Removed by the owner, 2026-09-25:** Railway may host production. A Railway production service sets `KOM_ENVIRONMENT=production`; its secrets are Railway variables. Settings live in the Railway dashboard (no Railway config files are needed) |
