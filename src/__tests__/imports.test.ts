 ...
 * CHK-09, CF-22): a mismatch is refused, never imported silently.
 */
...
describe("imports", () => {
  ...
  it("rejects a file whose name does not match the expected pattern (CF-22)", async () => {
  ...
  it("rejects a file whose name date is not the data date (CF-22)", async () => {
