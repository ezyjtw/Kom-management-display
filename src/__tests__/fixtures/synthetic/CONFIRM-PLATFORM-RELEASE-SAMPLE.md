> SYNTHETIC fixture built from the headings of "[Platform] Sprint X.XX Release Notes – Template" (spec §16.9).
> Not real release notes. TODO(CONFIRM-PLATFORM-RELEASE-SAMPLE): replace with a redacted real page once available.

# [Platform] Sprint 9.99 Release Notes
...
|---|---|---|---|
| Bulk withdrawal limits | Not started | Ann Operator | Disabled in PROD until Ops sign-off (PDEV-1201) |
|  |  |  |  |
...
|---|---|---|---|---|---|
| UAT | Ops UI | Transfer review | Filter by asset | Ops Admin | New asset filter on transfer review (PDEF-3301) |
...
|---|---|---|
| Auto-approval threshold | Threshold now per asset | PREL-88 |
