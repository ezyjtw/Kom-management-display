...
export const FLAG_DEFAULTS = Object.freeze({
  ...
  "incident_log.drafts.enabled": false,
  "module.bank": false,
...
export const SAFETY_FLAG_SEED: ReadonlyArray<{
  ...
  { key: "incident_log.drafts.enabled", name: "INC drafts", description: "Automated INC draft issues (spec §10.4); needs the INC log owner's agreement (CONFIRM-INCIDENT-LOG-OWNER)" },
  { key: "module.bank", name: "Bank module", description: "BANK MVP0 instruction register and settlement log (spec §12 TASK-BANK); process is draft, not operational" },
