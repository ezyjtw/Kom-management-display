...
export default function TransactionsPage() {
  ...
  const filteredTransactions = assetFilter
    ? transactions.filter((tx) => tx.asset === assetFilter)
    : transactions;
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      {/* Stats */}
      <TransactionStats transactions={filteredTransactions} requests={requests} />
      ...
      <div className="flex flex-wrap items-center gap-3 md:gap-4 bg-card rounded-xl border border-border p-3 md:p-4">
        ...
        {activeTab === "transactions" && assets.length > 0 && (
          <div>
      ...
      {loading ? (
        ...
        <PendingTransactionsTable transactions={filteredTransactions} />
      ) : (
