...
export async function PATCH(
  ...
  try {
    ...
    return await auditedResponse(
      { action: "travel_rule_case_updated", entityType: "travel_rule_case", entityId: new URL(request.url).pathname, userId: auditActorInfo.userId, summary: "Update a travel-rule case", metadata: auditActorInfo.metadata },
      async () => {
